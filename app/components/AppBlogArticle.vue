...
const ALL_POSTS: Array<{ href: string; title: string; excerpt: string }> = [
  ...
  {
    href: '/blog/platon-manipulyator/',
    title: 'Платон и манипулятор — когда владельцу КМУ нужно платить за федеральные трассы',
    excerpt: 'Порог — разрешённая максимальная масса свыше 12 т по ПТС, а не грузоподъёмность стрелы, и только федеральные трассы вроде М-7 «Волга». Тариф 5,19 ₽/км с 01.03.2026.',
  },
  {
  ...
  {
    href: '/blog/tskad-manipulyator/',
    title: 'ЦКАД и манипулятор — почему трёхосный КМУ платит по старшей категории',
    excerpt: 'Категорию на ЦКАД считают по числу осей и высоте, а не по массе. Трёхосный манипулятор всегда в старшей категории; полный круг — 6836 ₽ с 02.03.2026.',
  },
  {
    href: '/blog/manipulyator-noch-zakon-o-tishine/',
    title: 'Ночная разгрузка манипулятором — закон о тишине в Москве и области',
  ...
  },
  {
    ...
    excerpt: 'Правила № 878: 2 метра от трубы, письменное разрешение на работы глубже 0,3 м и запрет складировать груз в зоне без него.',
  },
  {
    href: '/blog/ohrannaya-zona-svyazi-manipulyator/',
    title: 'Манипулятор и охранная зона линии связи — 2 метра, которых не видно вовсе',
    excerpt: 'Правила № 578: охранная зона 2 метра от кабеля, вызов представителя оператора за 3 дня и штраф по ст. 13.5 КоАП за работу без согласования.',
  },
  {
    ...
    excerpt: 'Ст. 65 Водного кодекса: зона 50–200 м по длине реки, запрет стоянки вне дорог с твёрдым покрытием и штраф по ст. 8.42 КоАП.',
  },
  {
    href: '/blog/manipulyator-krai-kotlovana/',
    title: 'Манипулятор у котлована — почему нельзя ставить машину «на глаз»',
    excerpt: 'Расстояние от откоса до опоры крана по Таблице 2 ФНП №461 зависит от глубины выемки и вида грунта — единой цифры на все случаи в правиле нет.',
  },
  {
  ...
  },
  {
    ...
    title: 'Знак 3.4 «Движение грузовых запрещено» — когда манипулятору можно заехать под него',
  ...
  {
    href: '/blog/zhilaya-zona-razgruzka-manipulyator/',
    title: 'Манипулятор во дворе жилого дома — что разрешает и что запрещает ПДД в жилой зоне',
    excerpt: 'Двор по п. 17.4 ПДД приравнен к жилой зоне даже без знака 5.21: п. 17.2 запрещает стоянку грузовика тяжелее 3,5 т вне отведённых мест, а разгрузка — это «остановка», а не «стоянка».',
  },
  {
    href: '/blog/ogranichenie-vysoty-manipulyator/',
    title: 'Манипулятор и знак 3.13 «Ограничение высоты» — почему запас на путепроводе не для водителя',
    excerpt: 'КМУ на шасси обычно выше обычного борта — колонна, сложенная стрела и гидробак стоят над кабиной. Запас между цифрой на знаке и фактическим габаритом сооружения — не для водителя.',
  },
  {
    href: '/blog/znak-3-12-nagruzka-na-os-manipulyator/',
    title: 'Знак 3.12 «Ограничение массы на ось» и манипулятор — почему кран смещает нагрузку назад',
    excerpt: 'КМУ, стрела и груз у заднего борта грузят заднюю ось сильнее, чем равномерный борт. Ст. 12.21.1 КоАП РФ — с 18.07.2025 отвечает собственник машины.',
  },
  {
    href: '/blog/prosushka-dorog-manipulyator/',
    title: 'Просушка дорог и манипулятор — почему в Московской области весеннего ограничения нет',
    excerpt: 'С 2018 года область не снижает допустимую нагрузку на ось весной, в отличие от большинства соседних регионов. Где льгота заканчивается — на границе области.',
  },
  {
    href: '/blog/transportnoe-polozhenie-strely-manipulyator/',
    title: 'Транспортное положение стрелы манипулятора — почему нельзя ехать как удобнее',
    excerpt: 'Стрела вперёд или назад — вопрос инструкции производителя, а не привычки. Неправильное положение увеличивает длину машины без единого килограмма груза.',
  },
  {
    href: '/blog/manipulyator-zheleznodorozhnye-puti/',
    title: 'Манипулятор у железнодорожных путей — какое расстояние до рельса разрешено',
    excerpt: 'Не ближе 2 м от рельса, при штабеле выше 1,2 м — 2,5 м (п. 105 приказа №753н). Отдельно и шире — охранная зона РЖД по ПП №611.',
  },
  {
    href: '/blog/stoyanka-vo-dvore-manipulyator/',
    title: 'Стоянка манипулятора во дворе в Подмосковье — новый штраф с 1 сентября 2026 года',
    excerpt: 'До 50 000 ₽ за размещение грузовика во дворе (с исключением для погрузки-разгрузки) и до 100 000 ₽ за газон — уже без исключения. Ст. 6.22 КоАП МО, закон №102/2026-ОЗ.',
  },
  {
    href: '/blog/snt-dopusk-manipulyator/',
    title: 'Манипулятор и СНТ — почему проезд решает не ПДД, а общее собрание товарищества',
    excerpt: 'Дороги в СНТ — имущество общего пользования по 217-ФЗ, не публичная территория. Порядок проезда утверждает общее собрание 2/3 голосов, а не дорожный знак.',
  },
  {
    href: '/blog/kyuvet-sezd-na-uchastok-manipulyator/',
    title: 'Манипулятор и кювет перед участком — почему засыпать канаву нельзя, а разгрузить через неё можно',
    excerpt: 'Кювет — водоотводное сооружение дороги. Самодельный переезд — примыкание без согласия владельца (ст. 20 257-ФЗ, ч. 2 ст. 11.21 КоАП). Решение — стрелой с обочины.',
  },
  {
    href: '/blog/skolko-poddonov-v-manipulyator/',
    title: 'Сколько поддонов влезает в манипулятор — считаем по площади борта и по массе',
    excerpt: 'По площади на борт встаёт 6–16 поддонов 1200×800, но поддон кирпича весит 1,8–2,1 т — и загрузку ограничивает масса. Расчёт по четырём машинам парка.',
  },
  {
    href: '/blog/manipulyator-ili-avtokran/',
  ...
  {
    href: '/blog/stropalshchik-manipulyator/',
    title: 'Нужен ли стропальщик при разгрузке манипулятором',
    excerpt: 'Цеплять груз на крюк КМУ — только с квалификацией стропальщика, даже за петли (п. 216 ФНП № 461). Когда оператор справляется один и когда нужен сигнальщик.',
  },
  {
    href: '/blog/manipulyator-ili-gidrobort/',
    title: 'Манипулятор или грузовик с гидробортом — что заказать для поддонов',
    excerpt: 'Гидроборт Dhollandia DH-LM.10 опускает 500–1 000 кг за задний борт, дальше — рохля по асфальту. Поддон кирпича 2 т, грунт или забор — это манипулятор.',
  },
  {
    href: '/blog/manipulyator-zimoy-moroz-sneg/',
    title: 'Работает ли манипулятор зимой — мороз, снегопад и ветер',
    excerpt: 'Паспортный предел КМУ −40 °C, январь в Москве в среднем −6,2 °C. Останавливают работу видимость и ветер по п. 132 ФНП № 461, а ещё нечищеный подъезд.',
  },
]

// Внутренняя перелинковка блога, а не просто «читать дальше» (10.09.2026).
// Было: ALL_POSTS.filter(текущая исключена).slice(0, 3) — то есть ВСЕГДА первые
// три статьи массива (пропуск МКАД/ТТК, грузовой момент, ЛЭП). На 17 статьях это
// значит, что все 14 статей от 4-й позиции и дальше получают в разделе «Читать
// дальше» ОДИН И ТОТ ЖЕ фиксированный набор из трёх ссылок, а сами эти 14 статей
// не упоминаются в этом блоке НИ РАЗУ ни на одной из 17 страниц — весь блог
// ссылается только на первые три статьи по кругу. Три «счастливые» статьи получают
// по 16 входящих ссылок от соседей, остальные четырнадцать — ни одной.
// Живой пример: /blog/ohrannaya-zona-gazoprovoda-manipulyator/ и
// /blog/komponovka-i-upravlenie-kmu/ (обе — в списке малоценных страниц у
// Яндекса) не получали от этого блока ни одной ссылки, хотя он стоит внизу
// каждой из 17 статей.
// Правка: скользящее окно по кольцу ALL_POSTS — каждая статья ссылается на
// три СЛЕДУЮЩИЕ по порядку массива (с переходом в начало списка). Порядок
// массива не случаен: статьи в нём и так сгруппированы по темам волнами
// (пропуска и разрешения → устройство и допуск КМУ → охранные зоны → дорожные
// знаки), поэтому соседи по кольцу в большинстве случаев тематически близки —
// это не идеальная кураторская подборка, но реальная, а не фиктивная связь.
// Итог: у каждой из 17 статей теперь ровно 3 исходящих И ровно 3 входящих
// ссылки из этого блока — ни одна не остаётся сиротой.
const relatedPosts = computed(() => {
  const total = ALL_POSTS.length
  const i = ALL_POSTS.findIndex((p) => p.href === props.currentHref)
  if (i === -1) return ALL_POSTS.slice(0, 3)
  return [1, 2, 3].map((offset) => ALL_POSTS[(i + offset) % total])
})
