...
<main>
  ...
  <section class="section wrap" id="tarif">
    ...
    <div class="tarif-grid">
      <div class="prose">
        ...
        <p>Обратная ситуация в ближнем поясе. <NuxtLink to="/napravleniya/yaroslavskoe/">Мытищи</NuxtLink> — 1 км от МКАД, плечо 110 ₽: цена рейса практически равна ставке класса, и весь разговор сводится к тому, какая машина нужна, а не сколько до вас ехать.</p>
      </div>
      <AppTorqueDiagram />
    </div>
  </section>
  ...
  <section class="section wrap" id="napravleniya">
    <div class="section-head">
      <h2>Семь шоссе, а не семь районов</h2>
