...
const description = 'Новорижское, Ярославское, Симферопольское, Горьковское, Каширское, Ленинградское, Дмитровское: километраж от МКАД, профиль грузов и цена рейса.'
...
<main>
  ...
  <section class="section wrap" style="padding-top:8px">
    <div class="section-head">
      <h1>Семь шоссе от МКАД: плечо, груз и цена рейса</h1>
      <p>Семь шоссе от МКАД и двадцать три опорные точки на них: ближайшая — Мытищи в 1 км, дальняя — Кашира в 100 км. Доплата за плечо считается открыто, как км × 55 ₽ × 2, то есть от 110 до 11 000 ₽ за рейс, и на дальнем конце дорога стоит дороже смены лёгкого класса в 7 500 ₽.</p>
